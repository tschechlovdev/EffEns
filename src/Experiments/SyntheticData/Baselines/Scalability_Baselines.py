...
from Utils.Utils import clean_up_optimizer_directory, process_result_to_dataframe
...
dataset_types = DATASET_TYPES = ['varied', 'circles', 'moons']
...
result_file = "scalability_baselines.csv"
            ...
            for method in [
                ...
                for dataset_name, data in datasets.items():
                    ...
                    if method == "optics":
                        ...
                        results = pd.concat([results, consensus_result_df], ignore_index=True)
                        results.to_csv(result_file, index=False)
                        ...
                        optimizer = SMACOptimizer(dataset=X, cvi=cvi,
                                                  cs=cs_mapping[cs](k_range=k_range),
                                                  n_loops=n_loops,
                                                  wallclock_limit=360 * 60,
                                                  # cutoff_time=10,
                                                  seed=random_state,
                        ...
                        if method == "AutoClust" and X.shape[0] > 50000:
                        ...
                        if best_algorithm == ClusteringCS.MINI_BATCH_KMEANS and X.shape[0] >= 100000:
                            best_algorithm = ClusteringCS.GMM_ALGORITHM
